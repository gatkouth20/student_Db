...
Public Class ChallReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "supermarket_system.ChallReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedChallReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ChallReport = New ChallReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
