...
Public Class ChallReport1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "supermarket_system.ChallReport1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedChallReport1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ChallReport1 = New ChallReport1()
        rpt.Site = Me.Site
        Return rpt
    End Function
