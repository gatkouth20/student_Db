...
Public Class ChallReport2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "supermarket_system.ChallReport2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedChallReport2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ChallReport2 = New ChallReport2()
        rpt.Site = Me.Site
        Return rpt
    End Function
