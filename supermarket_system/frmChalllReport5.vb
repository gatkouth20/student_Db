...
Public Class frmChalllReport5
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "supermarket_system.frmChalllReport5.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedfrmChalllReport5
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As frmChalllReport5 = New frmChalllReport5()
        rpt.Site = Me.Site
        Return rpt
    End Function
